...
namespace MyWastedTime
{
    ...
    {
        public static SQLiteUtils DbSQLite = new SQLiteUtils();
        public static DbDatas DbMemory = new DbDatas();
        /// <summary>
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            //load db
            await App.DbSQLite.InitDb(null);
            int i = await App.DbMemory.DbData_Loading();
